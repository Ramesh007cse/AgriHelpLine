...
<?php
    ...
    if ($con) {
        if(isset($_POST["sub"])){
            ...
            $sql="insert into userregdata(Full_Name,Mobile_No,Email,Address,Gender,DOB,Profile,Status)values('$Full_Name','$Mobile_No','$Email','$Address','$Gender','$DOB','$Profile','$status')";
